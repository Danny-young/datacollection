    ...
    <header className="sticky top-0 z-10 border-b bg-background">
      <div className="container flex h-16 items-center justify-between py-4">
        ...
        <nav className="hidden md:flex gap-6">
          ...
          <Link
            href="/agents"
            className={isActive("/agents") ? "font-medium" : "text-muted-foreground hover:text-foreground"}
          >
            Agents
          </Link>
          <Link
            href="/properties"
            className={isActive("/properties") ? "font-medium" : "text-muted-foreground hover:text-foreground"}
          >
            Properties
          </Link>
          <Link
            href="/map"
            className={isActive("/map") ? "font-medium" : "text-muted-foreground hover:text-foreground"}
          >
            Map
          </Link>
          <Link
            href="/reports"
            className={isActive("/reports") ? "font-medium" : "text-muted-foreground hover:text-foreground"}
          >
            Reports
          </Link>
        </nav>
